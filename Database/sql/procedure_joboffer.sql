...
BEGIN  
    SELECT joboffer.idJobOffer, user.idUser, user.name, user.lastActivity, joboffer.description, joboffer.beginDate, joboffer.postDate, joboffer.price,joboffer.idCategory, joboffer.done, location.name AS location, location.cordsX, location.cordsY FROM joboffer
